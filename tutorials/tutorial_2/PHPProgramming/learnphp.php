...
<div class="container p-5">
    <h1 class="text-center">DATA GATHERED</h1>
    <?php 
    ...
    // Date
     ...
     echo date('h:i:s:u a, 1 F jS Y e'),"</br>";
     echo date('h:i:s: a, 1 F jS Y e'),"</br>";
    ?>
<table class="table">
  <thead>
    <tr>
...
//String
$str = <<<EOD
The customers name is $username and he/she live at $address in $streetaddress</br>
EOD;
...
$customer = array('Name'=>$username, 'Street'=>$address, 'City'=>$streetaddress);
